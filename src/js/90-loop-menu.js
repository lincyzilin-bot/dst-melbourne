...
function movePlayer(dt){
  ...
  if(P.moving){
    ...
    else if(gateMsg((x,z)=>isMoat(x,z),'🌊 Wide moat — cross at dirt fords (boat coming next)!'))blockedX=true;
...
function startRun(fresh){
  ...
  toast(fresh?'🧭 New run! Moat at fords, rivers at bridges (B). Wet D4 · Farm D5 · Ruins D7.':'🧭 Welcome back. Map saved.');
}
